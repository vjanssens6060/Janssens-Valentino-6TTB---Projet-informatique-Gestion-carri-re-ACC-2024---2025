...
class Application(ctk.CTk):
    ...
    def afficher_graphique(self):
        ...
        # Graphique des classements
        ax.set_xlabel("Courses (par circuit)")
        ax.set_ylabel("Classement", color="tab:red")
        ax.plot(circuits, classements, label="Classement", color="tab:red", marker="x")
        ax.tick_params(axis="y", labelcolor="tab:red")
        
        # Inverser l'axe des classements (1er en haut, dernier en bas)
        ax.invert_yaxis()

        # Ajouter un titre
        fig.suptitle("Évolution des classements")
        fig.tight_layout()
