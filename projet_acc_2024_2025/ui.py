...
class Application(ctk.CTk):
    ...
    def creer_onglet_courses(self):
        ...
        # 5. Création de la listbox AVANT son utilisation
        ...
        # 6. Zone d'affichage des courses
        ...
        # 8. Bouton pour modifier une course
        ...
        # 9. Afficher les courses existantes APRÈS création de tous les widgets
        self.afficher_courses_existantes()
    ...
    def afficher_courses_existantes(self):
        ...
        # Mettre à jour la listbox des courses
        self.courses_listbox.delete(0, tk.END)
        for course in self.carriere.courses:
            self.courses_listbox.insert(tk.END, f"{course.circuit} - Position: {course.classement}")
